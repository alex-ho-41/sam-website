            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex space-x-8 items-center">
                        <Link to="/" className="text-sm text-gray-700 hover:text-black transition-colors">關於</Link>
            ...
            {isOpen && (
                <div className="md:hidden bg-white border-b border-gray-100">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        <Link to="/" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-black hover:bg-gray-50 rounded-lg">關於</Link>
                        ...
                        <Link to="/maintenance" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-black hover:bg-gray-50 rounded-lg">業務</Link>
